...
<script type="text/javascript">
	function delete_id(id)
	{
		...
		if(r== true)
		{
			window.location.href='delete.php?tbl=stock& delete_id='+id;	
		}
...
$data="<body><div class='warper container-fluid'>
                <div class='panel panel-default'>
                    <div class='panel-heading'><h3>STOCK List</h3></div>
...
{
	$data.="<tr class='odd gradeX'><td>".$result[2]."</td><td>".$result[3]."</td><td>".$result[4]."</td><td>".$result[5]."</td><td>".$result[6]."</td><td>".$result[7]."</td><td><a href='javascript:delete_id(".$result[0].")'><i class='fa fa-trash'></i> </a></td></tr>";
}
